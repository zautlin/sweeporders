...
|--------|-------|
| **Total Matches** | 1,548 |
| **Total Trade Rows** | 3,096 (1,548 × 2) |
...
- ✅ Quantity consistency: aggressor qty = passive qty

### Data Integrity Checks
- ✅ Unique `matchgroupid` count: 1,548 (matches trade count)
- ✅ Each `matchgroupid` appears exactly twice
- ✅ Total quantity balanced across sides
- ✅ All timestamps in valid nanosecond format
- ✅ Prices match NBBO midpoint calculations
...
├── simulation_order_summary.csv      # Per-order summary
├── orders_with_simulated_metrics.csv # Orders with metrics
└── trade_level_comparison.csv        # Real vs simulated
```
